...
const Row2 = () => {
  ...
  const operationalExpenses = useMemo(() => {
    return (
      operationalData && //check data exists
  ...
  return (
    <>
      <DashboardBox gridArea="d">
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip />
            <Line yAxisId="left" type="monotone" dataKey="Non Operational Expenses" stroke={palette.tertiary[300]} />
      ...
      <DashboardBox gridArea="e">
        ...
        <Flexbetween mt="0.25rem" gap="1.5rem" pr="1rem">
          ...
          <Box flexBasis="40%" >
            ...
            <Typography variant='h6'>Margins are up from last month</Typography>
          </Box>
        </Flexbetween>
      </DashboardBox>
      ...
      <DashboardBox gridArea="f">
        <BoxHeader
          title="Product Prices vs Expences"
          subtitle=''
          sideText='+4%'
        />
        <ResponsiveContainer width="100%" height="100%">
